...
This file contains the class CompassPoints which is an enumeration to facilitate
the use of compass points names.
...
def degree_to_compass_points(degree: int) -> str:
    compass_points = [CompassPoints.N, CompassPoints.NE, CompassPoints.E,
                      CompassPoints.SE, CompassPoints.S, CompassPoints.SW,
                      CompassPoints.W, CompassPoints.NW]
